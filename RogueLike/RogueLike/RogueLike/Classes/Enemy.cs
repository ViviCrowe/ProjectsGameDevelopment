...
public class Enemy : Entity
{
    ...
    public void DropPotion(Room room, ContentManager content)
    {
        ...
        if(randomNumber < 0.6) room.items.Add(new Potion(300, this.Position, Potion.PotionType.HEALING));
        else if(randomNumber < 0.8) room.items.Add(new Potion(10, this.Position, Potion.PotionType.ATTACK));
